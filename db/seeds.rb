...
Role.create(name: 'Efterarbetare', body: 'Som en av efterarbetarna har du endast ett ansvar, att städa undan efter kvällsminglet som är på kvällen den 20:e februari.')
